...
SELECT DISTINCT JOINING_DATE, DEPARTMENT FROM Worker;
...
-- GROUP BY HAVING
SELECT DEPARTMENT, COUNT(*) AS Total_Department FROM Worker GROUP BY DEPARTMENT HAVING COUNT(Department) > 2;
